                ...
                <div className='container'>
                    ...
                    <form>
                        <div className='form-group'>
                            ...
                            <input type='text' value={form.name} onChange={onChange('name')} className='form-control' id='name' aria-describedby='name' placeholder='Nome da série' />
                        </div>

                        <div className='form-group'>
                            <label htmlFor='comments'>Comentários</label>
                            <input type='text' value={form.comments} onChange={onChange('comments')} className='form-control' id='comments' aria-describedby='comments' placeholder='Comentário' />
                        </div>
